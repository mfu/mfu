if(!dojo._hasResource["multiplefileuploader.tests.LifeCycle"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["multiplefileuploader.tests.LifeCycle"] = true;

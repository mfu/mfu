if(!dojo._hasResource["multiplefileuploader.tests.UploadManager"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["multiplefileuploader.tests.UploadManager"] = true;
...
dojo.require("multiplefileuploader.tests.FakeUploadStatusStrategy");
	...
	function onUploadRequestEnqueuedShouldBeTriggeredWhenWeAddToUploadQueue(t) {
		...
		dojo.mixin(uploadRequestMock, {
			...
			var uploadManager = new multiplefileuploader.widget.UploadManager({_uploadQueue  : fakeQueue}, "config_server", "config_status","config_UI");	

if(!dojo._hasResource["FlickrImageViewAssistant"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["FlickrImageViewAssistant"] = true;

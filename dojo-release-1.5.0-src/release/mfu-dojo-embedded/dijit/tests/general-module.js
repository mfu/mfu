if(!dojo._hasResource["dijit.tests.general-module"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dijit.tests.general-module"] = true;

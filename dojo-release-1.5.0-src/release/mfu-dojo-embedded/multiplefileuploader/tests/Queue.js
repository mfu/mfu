if(!dojo._hasResource["multiplefileuploader.tests.Queue"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["multiplefileuploader.tests.Queue"] = true;

if(!dojo._hasResource["dojox.mdnd.tests.robot.module"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.mdnd.tests.robot.module"] = true;

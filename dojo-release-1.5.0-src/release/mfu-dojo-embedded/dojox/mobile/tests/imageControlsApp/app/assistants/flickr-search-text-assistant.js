if(!dojo._hasResource["FlickrSearchTextAssistant"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["FlickrSearchTextAssistant"] = true;

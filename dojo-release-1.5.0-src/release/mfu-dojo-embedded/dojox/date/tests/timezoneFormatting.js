if(!dojo._hasResource["dojox.date.tests.timezoneFormatting"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.date.tests.timezoneFormatting"] = true;

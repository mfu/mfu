if(!dojo._hasResource["dojox.date.tests.hebrew.Date"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.date.tests.hebrew.Date"] = true;
	...
	[
		{
			...
			setUp: function(){
				...
				dojo.forEach(partLocaleList, function(locale){
					dojo.requireLocalization("dojo.cldr", "gregorian", locale, "ROOT,ar,ca,cs,da,de,el,en,en-au,en-ca,en-gb,es,fi,fr,he,hu,it,ja,ko,nb,nl,pl,pt,pt-pt,ru,sk,sl,sv,th,tr,zh,zh-tw");
					dojo.requireLocalization("dojo.cldr", "hebrew", locale, "ROOT,ar,he");
				});
			},
			runTest: function(t){
			},

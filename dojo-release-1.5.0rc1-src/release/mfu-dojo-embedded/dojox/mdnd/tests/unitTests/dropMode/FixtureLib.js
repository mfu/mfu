if(!dojo._hasResource["dojox.mdnd.tests.unitTests.dropMode.FixtureLib"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.mdnd.tests.unitTests.dropMode.FixtureLib"] = true;

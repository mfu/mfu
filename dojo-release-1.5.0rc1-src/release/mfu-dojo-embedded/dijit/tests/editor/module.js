if(!dojo._hasResource["dijit.tests.editor.module"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dijit.tests.editor.module"] = true;

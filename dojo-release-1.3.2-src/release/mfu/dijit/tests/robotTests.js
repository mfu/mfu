if(!dojo._hasResource["dijit.tests.robotTests"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dijit.tests.robotTests"] = true;
